package nl.pim16aap2.bigdoors.api.doors;
...
public interface IDoorBase
{
     ...
     */
    @NotNull IDoorBase setOpen(boolean bool);
     ...
     */
    @NotNull IDoorBase setLocked(boolean locked);
     ...
     */
    @NotNull IDoorBase setName(@NotNull String name);
     ...
     */
    @NotNull IDoorBase setOpenDir(@NotNull RotateDirection rotateDirection);
     ...
     * @return This {@link IDoorBase}.
     */
    @NotNull IDoorBase setPowerBlockPosition(@NotNull Vector3DiConst pos);
     ...
     * @return This {@link IDoorBase}.
     */
    @NotNull IDoorBase setEngine(@NotNull Vector3DiConst pos);
     ...
     * @return This {@link IDoorBase}.
     */
    @NotNull IDoorBase setCoordinates(@NotNull Vector3DiConst posA, @NotNull Vector3DiConst posB);
     ...
     * @return This {@link IDoorBase}.
     */
    @NotNull IDoorBase setCoordinates(@NotNull CuboidConst newCuboid);
