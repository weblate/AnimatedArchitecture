...
public interface IBigDoorsEventFactory
{
     ...
     */
    @NonNull IDoorCreatedEvent createDoorCreatedEvent(final @NonNull IDoorBase preview,
     ...
     * @param preview The preview of the door that is to be created.
     */
    default @NonNull IDoorCreatedEvent createDoorCreatedEvent(final @NonNull IDoorBase preview)
    {
     ...
     * @param responsible The {@link IPPlayer} responsible for the action, if a player was responsible for it.
     */
    @NonNull IDoorPrepareCreateEvent createPrepareDoorCreateEvent(final @NonNull IDoorBase door,
                                                                  final @Nullable IPPlayer responsible);
     ...
     * @param door The door that was created.
     */
    default @NonNull IDoorPrepareCreateEvent createPrepareDoorCreateEvent(final @NonNull IDoorBase door)
    {
     ...
     * @param responsible The {@link IPPlayer} responsible for the action, if a player was responsible for it.
     */
    @NonNull IDoorPrepareDeleteEvent createPrepareDeleteDoorEvent(final @NonNull IDoorBase door,
                                                                  final @Nullable IPPlayer responsible);
     ...
     * @param door The {@link IDoorBase} that will be deleted.
     */
    default @NonNull IDoorPrepareDeleteEvent createPrepareDeleteDoorEvent(final @NonNull IDoorBase door)
    {
     ...
     * @param responsible The {@link IPPlayer} responsible for the action, if a player was responsible for it.
     */
    @NonNull IDoorPrepareAddOwnerEvent createDoorPrepareAddOwnerEvent(final @NonNull IDoorBase door,
     ...
     * @param newOwner The new {@link DoorOwner} that is to be added to the door.
     */
    default @NonNull IDoorPrepareAddOwnerEvent createDoorPrepareAddOwnerEvent(final @NonNull IDoorBase door,
                                                                              final @NonNull DoorOwner newOwner)
    {
     ...
     * @param responsible  The {@link IPPlayer} responsible for the action, if a player was responsible for it.
     */
    @NonNull IDoorPrepareRemoveOwnerEvent createDoorPrepareRemoveOwnerEvent(final @NonNull IDoorBase door,
     ...
     * @param removedOwner The {@link DoorOwner} that is to be removed from the door.
     */
    default @NonNull IDoorPrepareRemoveOwnerEvent createDoorPrepareRemoveOwnerEvent(final @NonNull IDoorBase door,
                                                                                    final @NonNull DoorOwner removedOwner)
    {
     ...
     * @param responsible   The {@link IPPlayer} responsible for the action, if a player was responsible for it.
     */
    @NonNull IDoorPrepareLockChangeEvent createDoorPrepareLockChangeEvent(final @NonNull IDoorBase door,
     ...
     * @param newLockStatus The new locked status of the door.
     */
    default @NonNull IDoorPrepareLockChangeEvent createDoorPrepareLockChangeEvent(final @NonNull IDoorBase door,
                                                                                  final boolean newLockStatus)
    {
     ...
     */
    @NonNull IDoorEventTogglePrepare createTogglePrepareEvent(@NonNull IDoorBase door,
     ...
     * @param newCuboid     The {@link CuboidConst} representing the area the door will take up after the toggle.
     */
    @NonNull IDoorEventToggleStart createToggleStartEvent(@NonNull IDoorBase door,
                                                          @NonNull DoorActionCause cause,
                                                          @NonNull DoorActionType actionType,
                                                          @NonNull IPPlayer responsible, double time,
     ...
     * @param skipAnimation If true, the door will skip the animation and open instantly.
     */
    @NonNull IDoorEventToggleEnd createToggleEndEvent(@NonNull IDoorBase door,
                                                      @NonNull DoorActionCause cause,
                                                      @NonNull DoorActionType actionType,
                                                      @NonNull IPPlayer responsible, double time,
                                                      boolean skipAnimation);
