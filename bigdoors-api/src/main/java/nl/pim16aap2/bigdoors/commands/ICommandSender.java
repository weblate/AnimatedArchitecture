...
public interface ICommandSender extends IMessageable
{
     ...
     */
    default @NonNull CompletableFuture<Boolean> hasPermission(final @NonNull String permission)
    {
     ...
     */
    default @NonNull CompletableFuture<BooleanPair> hasPermission(final @NonNull ICommandDefinition command)
    {
