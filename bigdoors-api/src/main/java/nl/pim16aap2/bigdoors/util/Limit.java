...
public enum Limit
{
    ...
    @Getter
    private final @NonNull String userPermission;
    @Getter
    private final @NonNull String adminPermission;
    private final @NonNull Function<IConfigLoader, OptionalInt> globalLimitSupplier;
