...
public final class ConfigLoaderSpigot implements IConfigLoader
{
    ...
    private final @NotNull Map<IDoorType, String> doorPrices;
    private final @NotNull Map<IDoorType, Double> doorMultipliers;
     ...
     */
    private ConfigLoaderSpigot(final @NotNull BigDoorsSpigot bigDoorsSpigot, final @NotNull IPLogger logger)
    {
    ...
    @Override
    public @NotNull String getPrice(final @NotNull IDoorType type)
    {
    ...
    @Override
    public double getMultiplier(final @NotNull IDoorType type)
    {
